export const cartItemsTotalPrice = (items, coupon = null) => {
  const total = items.reduce((price, product) => {
...
const removeItemFromCart = (state, action) => state.items.reduce((acc, item) => {
...
const clearItemFromCart = (state, action) => state.items
