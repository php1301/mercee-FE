...
export default function ProductDetails() {
  ...
  //   addItem được assigned từ addItemHandler
  //   addItemHandler là 1 trong các hàm
  //   Bắn dispatch tới reducer của cart
  //   Có được khi return useCartActions
  //   dispatch action 'ADD_ITEM' và gọi hàm addItemToCart
